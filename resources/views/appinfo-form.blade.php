    ...
    <div class="container py-2">
        <div class="card shadow bg-dark">
                ...
                <form name="add-add-info-form" id="add-app-info-form" method="post" action="{{ $formAction ?? route('store_app_info') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group col-md-9">
                            ...
                            @includeWhen(isset($appInfo) && !empty($appInfo->appstore_id), 'layouts.dashboard.copy-clipboard-button', ['input' => 'appstore_id'])
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group col-md-9">
                            ...
                            @includeWhen(isset($appInfo) && !empty($appInfo->app_bundle), 'layouts.dashboard.copy-clipboard-button', ['input' => 'app_bundle'])
                        </div>
                    </div>
                    <div class="form-group row">
                        @if (!isset($appInfo))
                        ...
                        @else
                            <label for="project_name" class="col-md-3 col-form-label text-white font-weight-bold">
                                <i class="fa-solid fa-code-fork" aria-hidden="true"></i> Project Source
                            </label>
                            <div class="input-group col-md-9">
                    ...
                    <div class="collapse" id="collapse_keys">
                        <div class="form-group row">
                            ...
                            <div class="input-group col-md-9">
                                ...
                                @endif
                                @includeWhen(isset($appInfo) && !empty($appInfo->fb_app_id), 'layouts.dashboard.copy-clipboard-button', ['input' => 'fb_app_id'])
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-md-9">
                                ...
                                @includeWhen(isset($appInfo) && !empty($appInfo->fb_client_token), 'layouts.dashboard.copy-clipboard-button', ['input' => 'fb_client_token'])
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-md-9">
                                ...
                                @includeWhen(isset($appInfo) && !empty($appInfo->ga_id), 'layouts.dashboard.copy-clipboard-button', ['input' => 'ga_id'])
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-md-9">
                                ...
                                @includeWhen(isset($appInfo) && !empty($appInfo->ga_secret), 'layouts.dashboard.copy-clipboard-button', ['input' => 'ga_secret'])
                            </div>
                        </div>
                    </div>
                    <br/>
                    ...
                    @include('layouts.dashboard.button-success', [
                        'icon' => isset($appInfo) ? 'fa-pen-to-square' : 'fa-square-check',
                        'name' => $title
                    ])
                </form>
            </div>
            @php ($footerText = !isset($appInfo)
                ...
                : "<b>Store</b> and <b>Project Source</b> related settings can not be changed.")
