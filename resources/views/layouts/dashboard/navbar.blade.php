<div class="container-fluid">
    <nav class="navbar navbar-expand-sm navbar-dark shadow">
        ...
        <button class="navbar-toggler bg-dark border-0" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
